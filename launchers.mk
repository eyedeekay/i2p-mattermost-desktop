...
desktop:
	...
	#@echo "export no_proxy='127.0.0.1:8065'" | tee -a usr/bin/mattermost-i2p
	...
	@echo "/opt/Mattermost/mattermost-desktop --proxy-server=\"127.0.0.1:0\" --proxy-bypass-list=\"\$$MMC_HOST:\$$MMC_PORT\"" | tee -a usr/bin/mattermost-i2p
